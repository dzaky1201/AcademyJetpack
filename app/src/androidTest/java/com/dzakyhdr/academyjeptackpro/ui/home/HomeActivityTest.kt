...
class HomeActivityTest{
    ...
    fun loadDetailModule() {
        ...
        onView(withId(R.id.btn_start)).perform(ViewActions.click())
        onView(withId(R.id.rv_module)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(0,
            ViewActions.click()
        ))
    ...
    @Test
    fun loadBookmarks() {
        onView(withText("Bookmark")).perform(ViewActions.click())
